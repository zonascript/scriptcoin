...
<div align="center">
 <div class="form_style" style="width:70%" align="center">
  <div align="center"><strong><a href="?go=configuration&sess=web"><button class="submitkecil" type="button">Web Configuration</button></a>&nbsp;<a href="?go=configuration&sess=admin"><button class="submitkecil" type="button">Admin Configuration</button></a>&nbsp;<a href="?go=configuration&sess=system"><button class="submitkecil" type="button">System Configuration</button></a>&nbsp;<a href="?go=configpayment"><button class="submitkecil" type="button">System Configuration</button></a></strong></div>
  <p>&nbsp;</p>
<?php
